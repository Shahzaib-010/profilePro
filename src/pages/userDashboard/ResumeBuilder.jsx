...
function ResumeBuilder() {
  ...
  // Called by each step on successful validation
  ...
  const renderStep = () => {
    switch (currentStep) {
      case 1: return <Step1 ref={stepRef} defaultValues={resumeData.step1} onSave={(v) => handleStepSave("step1", v)} />;
      case 2: return <Step2 ref={stepRef} defaultValues={resumeData.step2} onSave={(v) => handleStepSave("step2", v)} />;
      case 3: return <Step3 ref={stepRef} defaultValues={resumeData.step3} onSave={(v) => handleStepSave("step3", v)} />;
      case 4: return <Step4 ref={stepRef} defaultValues={resumeData.step4} onSave={(v) => handleStepSave("step4", v)} />;
      default: return null;
    }
  };
